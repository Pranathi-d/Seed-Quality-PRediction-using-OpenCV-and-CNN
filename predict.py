...
nimage = cv2.imread(r"C:\Users\prana\OneDrive\Desktop\data\validation\discolored\dc354_broken_003_bottom_000.png", cv2.IMREAD_GRAYSCALE)
...
img = mpimg.imread(r"C:\Users\prana\OneDrive\Desktop\data\train\broken\dc354_broken_000_bottom_005.png")
plt.imshow(img)
